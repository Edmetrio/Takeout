...
<!-- Mirrored from frontend.big-skins.com/goodwin-html-demo/account-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Dec 2020 21:18:52 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>Goodwin HTML Template - My account</title>
    <link rel="shortcut icon" type="image/x-icon" href="images/favicon.ico">
    <!-- Vendor CSS -->
    <link href="{{asset('js/vendor/bootstrap/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('js/vendor/slick/slick.min.css')}}" rel="stylesheet">
    <link href="{{asset('js/vendor/fancybox/jquery.fancybox.min.css')}}" rel="stylesheet">
    <link href="{{asset('js/vendor/animate/animate.min.css')}}" rel="stylesheet">
    <!-- Custom styles for this template -->
    <link href="{{asset('css/style-light.css')}}" rel="stylesheet">
    <!--icon font-->
...
<body class="is-dropdn-click">
    ...
    <header class="hdr global_width hdr_sticky hdr-mobile-style2">
                    ...
                    <div class="nav-wrapper show-menu">
                        ...
                        <ul class="nav nav-level-1">
                            ...
                            <li><a href="#" title="">Pages</a><span class="arrow"></span>
                                <ul class="nav-level-2">
                                    <li><a href="index.html" title="">Product page</a><span class="arrow"></span>
                            ...
                            <li><a href="#" title="">Features</a><span class="arrow"></span>
                                <ul class="nav-level-2">
                                    <li><a href="index.html" title="">Headers</a><span class="arrow"></span>
                                        <ul class="nav-level-3">
                                            <li><a href="index.html" title="">Header 1</a></li>
                                    ...
                                    <li><a href="index.html" title="">Footers</a><span class="arrow"></span>
                                        <ul class="nav-level-3">
                                            <li><a href="index.html" title="">Footer 1</a></li>
        ...
        <div class="hdr-desktop hide-mobile">
            ...
            <div class="hdr-content hide-mobile">
                <div class="container">
                    <div class="row">
                        <div class="col-auto logo-holder"><a href="index.html" class="logo"><img src="images/logo.png" srcset="images/logo-retina.png 2x" alt=""></a></div>
                        <!--navigation-->
                            ...
                            <div class="hdr-nav">
                                ...
                                <ul class="mmenu mmenu-js">
                                    ...
                                    <li class="mmenu-item--simple"><a href="#" title="">Pages</a>
                                        <div class="mmenu-submenu">
                                            <ul class="submenu-list">
                                                <li><a href="index.html" title="">Product page</a>
                                                    <ul>
                                                        <li><a href="product.html" title="">Product page variant 1</a></li>
                                                        <li><a href="product-2.html" title="">Product page variant 2</a></li>
                                                        <li><a href="product-3.html" title="">Product page variant 3</a></li>
        ...
        <div class="sticky-holder compensate-for-scrollbar">
            <div class="container">
                <div class="row"><a href="#" class="mobilemenu-toggle show-mobile"><i class="icon icon-menu"></i></a>
                    <div class="col-auto logo-holder-s"><a href="index.html" class="logo"><img src="images/logo.png" srcset="images/logo-retina.png 2x" alt=""></a></div>
                    <!--navigation-->
                    <div class="prev-menu-scroll icon-angle-left prev-menu-js"></div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 aside aside--left">
                        <div class="list-group"><a href="account-details.html" class="list-group-item active">Account Details</a> <a href="account-addresses.html" class="list-group-item">My Addresses</a> <a href="account-wishlist.html" class="list-group-item">My Wishlist</a> <a href="account-history.html" class="list-group-item">My Order History</a> <a href="#" class="list-group-item">My Reviews</a> <a href="#" class="list-group-item">My Saved Tags</a> <a href="#" class="list-group-item">Compare Products</a></div>
                    </div>
    ...
    <script src="{{asset('js/vendor/scrollLock/jquery-scrollLock.min.js')}}"></script>
    <script src="{{asset('js/vendor/instafeed/instafeed.min.js')}}"></script>
    <script src="{{asset('js/vendor/countdown/jquery.countdown.min.js')}}"></script>
    <script src="{{asset('js/vendor/imagesloaded/imagesloaded.pkgd.min.js')}}"></script>
    <script src="{{asset('js/vendor/ez-plus/jquery.ez-plus.min.js')}}"></script>
    <script src="{{asset('js/vendor/tocca/tocca.min.js')}}"></script>
    <script src="{{asset('js/vendor/bootstrap-tabcollapse/bootstrap-tabcollapse.min.js')}}"></script>
    <script src="{{asset('js/vendor/isotope/jquery.isotope.min.js')}}"></script>
    <script src="{{asset('js/vendor/fancybox/jquery.fancybox.min.js')}}"></script>
    <script src="{{asset('js/vendor/cookie/jquery.cookie.min.js')}}"></script>
    <script src="{{asset('js/vendor/bootstrap-select/bootstrap-select.min.js')}}"></script>
    <script src="{{asset('js/vendor/lazysizes/lazysizes.min.js')}}"></script>
    <script src="{{asset('js/vendor/lazysizes/ls.bgset.min.js')}}"></script>
    <script src="{{asset('js/vendor/form/jquery.form.min.js')}}"></script>
    <script src="{{asset('js/vendor/form/validator.min.js')}}"></script>
    <script src="{{asset('js/vendor/slider/slider.js')}}"></script>
